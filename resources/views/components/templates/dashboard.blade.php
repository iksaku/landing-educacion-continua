                        ...
                        >
                            <div>
                                <button type="button" class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=VlAmqSRrnM&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                                </button>
                            </div>
                            ...
                            <div
                                ...
                                x-show="isOpen"
                                x-transtion:enter="transition ease-out duration-100"
                                x-transtion:enter-start="transform opacity-0 scale-95"
                                x-transtion:enter-end="transform opacity-100 scale-100"
                                x-transtion:leave="transition ease-in duration-75"
                                x-transtion:leave-start="transform opacity-100 scale-100"
                                x-transtion:leave-end="transform opacity-0 scale-95"
                            ...
                            >
                                ...
                                <a href="#" class="block" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</a>
                                <form action="{{ route('logout') }}" method="post" class="contents">
                                    <button type="submit" class="hover:focus:bg-red-500 text-sm text-gray-700 hover:focus:text-gray-100 px-4 py-2">
                                        Cerrar Sesión
                                    </button>
                                </form>
                            </div>
